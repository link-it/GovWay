...
CREATE SEQUENCE seq_plugins_servizi_comp start 1 increment 1 maxvalue 9223372036854775807 minvalue 1 cache 1 NO CYCLE;
...
(
	...
	-- fk/pk columns
	id BIGINT DEFAULT nextval('seq_plugins_servizi_comp') NOT NULL,
...
CREATE SEQUENCE seq_plugins_azioni_comp start 1 increment 1 maxvalue 9223372036854775807 minvalue 1 cache 1 NO CYCLE;

CREATE TABLE plugins_azioni_comp
(
	azione VARCHAR(255) NOT NULL,
	-- fk/pk columns
	id BIGINT DEFAULT nextval('seq_plugins_azioni_comp') NOT NULL,
...
CREATE SEQUENCE seq_plugins_conf_servizi start 1 increment 1 maxvalue 9223372036854775807 minvalue 1 cache 1 NO CYCLE;
...
(
	...
	servizio VARCHAR(255),
	-- fk/pk columns
	id BIGINT DEFAULT nextval('seq_plugins_conf_servizi') NOT NULL,
	-- fk/pk keys constraints
...
CREATE SEQUENCE seq_plugins_conf_azioni start 1 increment 1 maxvalue 9223372036854775807 minvalue 1 cache 1 NO CYCLE;

CREATE TABLE plugins_conf_azioni
(
	azione VARCHAR(255) NOT NULL,
	-- fk/pk columns
	id BIGINT DEFAULT nextval('seq_plugins_conf_azioni') NOT NULL,
...
CREATE SEQUENCE seq_plugins_conf_filtri start 1 increment 1 maxvalue 9223372036854775807 minvalue 1 cache 1 NO CYCLE;

...
public abstract class AbstractDeserializer extends org.openspcoop2.generic_project.serializer.AbstractDeserializer {
	...
	*/
	...
	/**
	 * Transform the xml in <var>fileName</var> in the object type {@link org.openspcoop2.monitor.engine.config.base.PluginFiltroCompatibilita}
	 * 
	 * @param fileName Xml file to use for the reconstruction of the object type {@link org.openspcoop2.monitor.engine.config.base.PluginFiltroCompatibilita}
	 * @return Object type {@link org.openspcoop2.monitor.engine.config.base.PluginFiltroCompatibilita}
	 * @throws DeserializerException The exception that is thrown when an error occurs during deserialization
	 */
	public PluginFiltroCompatibilita readPluginFiltroCompatibilita(String fileName) throws DeserializerException {
		return (PluginFiltroCompatibilita) this.xmlToObj(fileName, PluginFiltroCompatibilita.class);
	}
	
	/**
	 * Transform the xml in <var>file</var> in the object type {@link org.openspcoop2.monitor.engine.config.base.PluginFiltroCompatibilita}
	 * 
	 * @param file Xml file to use for the reconstruction of the object type {@link org.openspcoop2.monitor.engine.config.base.PluginFiltroCompatibilita}
	 * @return Object type {@link org.openspcoop2.monitor.engine.config.base.PluginFiltroCompatibilita}
	 * @throws DeserializerException The exception that is thrown when an error occurs during deserialization
	 */
	public PluginFiltroCompatibilita readPluginFiltroCompatibilita(File file) throws DeserializerException {
		return (PluginFiltroCompatibilita) this.xmlToObj(file, PluginFiltroCompatibilita.class);
	}
	
	/**
	 * Transform the input stream <var>in</var> in the object type {@link org.openspcoop2.monitor.engine.config.base.PluginFiltroCompatibilita}
	 * 
	 * @param in InputStream to use for the reconstruction of the object type {@link org.openspcoop2.monitor.engine.config.base.PluginFiltroCompatibilita}
	 * @return Object type {@link org.openspcoop2.monitor.engine.config.base.PluginFiltroCompatibilita}
	 * @throws DeserializerException The exception that is thrown when an error occurs during deserialization
	 */
	public PluginFiltroCompatibilita readPluginFiltroCompatibilita(InputStream in) throws DeserializerException {
		return (PluginFiltroCompatibilita) this.xmlToObj(in, PluginFiltroCompatibilita.class);
	}	
	
	/**
	 * Transform the byte array <var>in</var> in the object type {@link org.openspcoop2.monitor.engine.config.base.PluginFiltroCompatibilita}
	 * 
	 * @param in Byte array to use for the reconstruction of the object type {@link org.openspcoop2.monitor.engine.config.base.PluginFiltroCompatibilita}
	 * @return Object type {@link org.openspcoop2.monitor.engine.config.base.PluginFiltroCompatibilita}
	 * @throws DeserializerException The exception that is thrown when an error occurs during deserialization
	 */
	public PluginFiltroCompatibilita readPluginFiltroCompatibilita(byte[] in) throws DeserializerException {
		return (PluginFiltroCompatibilita) this.xmlToObj(in, PluginFiltroCompatibilita.class);
	}	
	
	/**
	 * Transform the String <var>in</var> in the object type {@link org.openspcoop2.monitor.engine.config.base.PluginFiltroCompatibilita}
	 * 
	 * @param in String to use for the reconstruction of the object type {@link org.openspcoop2.monitor.engine.config.base.PluginFiltroCompatibilita}
	 * @return Object type {@link org.openspcoop2.monitor.engine.config.base.PluginFiltroCompatibilita}
	 * @throws DeserializerException The exception that is thrown when an error occurs during deserialization
	 */
	public PluginFiltroCompatibilita readPluginFiltroCompatibilitaFromString(String in) throws DeserializerException {
		return (PluginFiltroCompatibilita) this.xmlToObj(in.getBytes(), PluginFiltroCompatibilita.class);
	}	

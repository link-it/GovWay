...
/** <p>Java class for plugin-filtro-compatibilita complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="plugin-filtro-compatibilita"&gt;
 * 		&lt;sequence&gt;
...
@XmlType(name = "plugin-filtro-compatibilita", 
  propOrder = {
  	"tipoMittente",
  	"nomeMittente",
  	"idportaMittente",
...
@XmlRootElement(name = "plugin-filtro-compatibilita")

public class PluginFiltroCompatibilita extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {
  public PluginFiltroCompatibilita() {
  }

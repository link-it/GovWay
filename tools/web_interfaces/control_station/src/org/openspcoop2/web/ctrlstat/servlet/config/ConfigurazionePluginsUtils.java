...
public class ConfigurazionePluginsUtils {
	...
	public static void deletePlugin(Long idPlugin, String userLogin, ConfigurazioneCore confCore, ConfigurazioneHelper confHelper,
		...
		boolean ruoloInUso = confCore.isPluginInUso(plugin.getClassName(), 
